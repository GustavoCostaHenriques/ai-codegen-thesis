...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.2\textheight, width=0.45\textwidth]{pic/waterfall_agille.png}
...
\begin{figure*}[!ht]
    \centering
    \includegraphics[width=0.85\textwidth]{pic/codellama_family.pdf}
...
\noindent{Dando} seguimento a esta evolução, surgiram modelos especializados na geração de código, como o CodeLlama \cite{CodeLlama}, uma família de modelos baseada no Llama2 \cite{Llama2}, orientada para tarefas como geração, explicação e completamento de código. Estes modelos incluem variantes adaptadas a diferentes contextos de utilização, nomeadamente para suporte a linguagens específicas ou para melhor seguimento de instruções.

\noindent{Tal} como outros modelos da mesma geração, o CodeLlama foi treinado em grandes volumes de código e linguagem natural, permitindo lidar com sintaxe estruturada e múltiplos paradigmas de programação. A Figura \ref{fig:codellama-pipeline} ilustra o processo de especialização destes modelos.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.3\textheight, width=0.2\textwidth]{pic/code_generation_tineline.png}
