...
import weekResolve from './week-routing-resolve.service';

describe('Week routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: WeekService;
  let resultWeek: IWeek | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IWeek returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        weekResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultWeek = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultWeek).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IWeek>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
