...
import { sampleWithRequiredData } from '../day-plan.test-samples';
...
describe('DayPlan Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.dayPlans()[0]).toEqual(expect.objectContaining({ id: 25287 }));
  });

  describe('trackId', () => {
    it('should forward to dayPlanService', () => {
      const entity = { id: 25287 };
      jest.spyOn(service, 'getDayPlanIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDayPlanIdentifier).toHaveBeenCalledWith(entity);
