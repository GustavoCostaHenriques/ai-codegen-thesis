...
/**
 * Criteria class for the {@link com.mycompany.weeklyplanning.domain.ProjectEntity} entity. This class is used
 * in {@link com.mycompany.weeklyplanning.web.rest.ProjectResource} to receive all the possible filtering options from
...
public class ProjectCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, assignmentsId, distinct);
    }
