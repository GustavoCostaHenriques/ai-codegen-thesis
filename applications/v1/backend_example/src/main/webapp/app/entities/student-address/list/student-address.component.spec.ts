...
import { sampleWithRequiredData } from '../student-address.test-samples';
...
describe('StudentAddress Management Component', () => {
  let comp: StudentAddressComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StudentAddressComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.studentAddresses()[0]).toEqual(expect.objectContaining({ id: 10602 }));
  });

  describe('trackId', () => {
    it('should forward to studentAddressService', () => {
      const entity = { id: 10602 };
      jest.spyOn(service, 'getStudentAddressIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStudentAddressIdentifier).toHaveBeenCalledWith(entity);
