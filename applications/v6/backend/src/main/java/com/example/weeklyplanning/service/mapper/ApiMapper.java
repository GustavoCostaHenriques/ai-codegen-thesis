...
public class ApiMapper {
    ...
    public DayProject toDayProject(DayProjectEntity entity, UUID viewerPersonId) {
        boolean viewerAssignedToProject = viewerPersonId == null || entity.getAssignments().stream()
            .anyMatch(assignment -> assignment.getPerson().getId().equals(viewerPersonId));
        ...
        return new DayProject(entity.getId(), toProjectSummary(entity.getProject()), viewerAssignedToProject ? assignments : List.of());
    }
