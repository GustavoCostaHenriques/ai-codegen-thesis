...
import static com.weeklyplanning.domain.ProjectAsserts.*;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).code(DEFAULT_CODE).status(DEFAULT_STATUS);
        // Add required entity
        Person person;
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project updatedProject = new Project().name(UPDATED_NAME).code(UPDATED_CODE).status(UPDATED_STATUS);
        // Add required entity
        Person person;
        if (TestUtil.findAll(em, Person.class).isEmpty()) {
        ...
        updatedProject.setOwner(person);
    ...
    void putExistingProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).code(UPDATED_CODE).status(UPDATED_STATUS);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.code(UPDATED_CODE);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).code(UPDATED_CODE).status(UPDATED_STATUS);
